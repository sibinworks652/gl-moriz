...
<head>
    ...
    <title>New Update Subscription</title>
</head>
<body style="margin:0;padding:0;background:#f4f7fb;font-family:Arial,Helvetica,sans-serif;color:#1f2a37;">
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#f4f7fb;margin:0;padding:28px 12px;">
        <tr>
            <td align="center">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#ffffff;border-radius:8px;overflow:hidden;border:1px solid #e3e8ef;">
                <tr>
                    ...
                    <tr>
                        ...
                        <h3 style="margin:8px 0 0;font-size:18px;line-height:1.3;font-weight:700; margin-bottom:10px;">New Update Subscription</h3>
                            <p style="margin:0 0 22px;font-size:15px;line-height:1.6;color:#4b5563;">
                                A visitor subscribed to receive updates.
                            </p>

                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
                                <tr>
                                    <td style="padding:12px 0;border-bottom:1px solid #edf1f5;width:120px;color:#64748b;font-size:13px;">Email</td>
                                    <td style="padding:12px 0;border-bottom:1px solid #edf1f5;font-size:15px;">
                                        <a href="mailto:<?= esc($email) ?>" style="color:#1f6f9f;text-decoration:none;font-weight:600;"><?= esc($email) ?></a>
                                    </td>
                                </tr>
                                <?php if (! empty($page)): ?>
                                <tr>
                                    ...
                                    <td style="padding:12px 0;border-bottom:1px solid #edf1f5;font-size:15px;">
                                        <a href="<?= esc($page) ?>" style="color:#1f6f9f;text-decoration:none;"><?= esc($page) ?></a>
                                    </td>
                                </tr>
                                <?php endif; ?>
                            </table>
                    ...
                    <tr>
                        <td style="padding:18px 28px;background:#f8fafc;color:#64748b;font-size:12px;line-height:1.5;">
                            This message was sent from the Moriz website footer subscription form.
                        </td>
                    </tr>
                </table>
            </td>
