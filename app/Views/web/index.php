    ...
    <div class="video_slider_wrapper_vy">
        ...
        <div class="video_slide_vy active">
            ...
            <div class="content_vy">
                ...
                <span class="tag_vy">Moriz Meditech provides advanced dental products that support clinicians in
                    delivering superior patient care.</span>

                <div class="gl-po-rel gl-d-flex gl-fd-row gap-20">
                    <a href="/product-landing" class="common-btn gl-td-none gl-pt-40 gl-xs-pt-20">
        ...
        <div class="banr_box">
            <a href="#" id="banrLink" class="gl-td-none">
            <div class="banr_inner">
                <div class="banr_img" style="width: 120px;">
                    <img id="banrImage" src="" alt="">
                </div>
                <div class="banr_content gl-w-100 gl-po-rel gl-d-flex gl-fd-row">
                    <h4 class="gl-d-flex bnr-slide-txt" id="banrText"></h4>
                    <span class="gl-d-flex banr-slide-num" id="banrNumber"></span>
                </div>
...
<div class="container-common ">
    <div class="precision_area_box gl-pt-70 gl-xs-pt-30 gl-of-hide">
        ...
        <div class="precision_card precision_center">
            <div class="precision_content">
                ...
                <p>
                    We develop advanced dental materials and solutions, including orthodontic systems, instruments, and
                    restorative products, designed for dentists and laboratories in daily treatments.
                </p>
            ...
            <div class="read_more_wrap">
                <a href="about-us" class="read_more_btn">
                    Read More
...
<section class="beyond_quality_area">
    <div class="container-common">
        ...
        <div class="beyond_head">
            ...
            <h2 class="g-slide-up">Clinical Quality<br>Consistent Results</h2>
            <p class="g-slide-up">
    ...
    <div class="beyond_quality_sec">
        ...
        <div class="beyond_quality_top">
            <div class="beyond_quality_left">
                <div class="beyond_quality_title g-slide-up">
            ...
            <div class="beyond_quality_right">
                <div class="beyond_quality_desc">
                    Developed for real clinical use, our materials provide strength, durability, accuracy, and
        ...
        <div class="beyond_quality_grid">
            ...
            <div class="beyond_quality_card">
                ...
                <div class="beyond_quality_card_desc">
                    Built to handle everyday clinical stress, our materials maintain their structure and perform
            ...
            <div class="beyond_quality_card">
                ...
                <div class="beyond_quality_card_desc">
                    Designed for long-term use, our materials stay stable and dependable even under demanding clinical
                    conditions.
                </div>
            </div>
            ...
            <div class="beyond_quality_card">
                ...
                <div class="beyond_quality_card_desc">
                    Made for precise handling, our materials help achieve accurate results across both digital and
                    chairside workflows.
                </div>
            </div>
            ...
            <div class="beyond_quality_card">
                ...
                <div class="beyond_quality_card_desc">
                    With consistent quality in every batch, clinicians can expect reliable results every time they use
                    our products.
                </div>
            </div>
...
<div class="container-common ">
    <div class="qstn_accor gl-mt-35 gl-xs-mt-0">
        ...
        <div class="qstn_accor_inner">
            ...
            <!-- RIGHT ACCORDION -->
            <div class="qstn_accor_box g-slide-up">
                ...
                <div class="qstn_item active">
                    ...
                    <div class="qstn_body">
                        Orthodontics is a branch of dentistry that focuses on correcting misaligned teeth and jaws to
                ...
                <div class="qstn_item">
                    ...
                    <div class="qstn_body">Yes, transparent aligners work by applying controlled pressure to gradually
                        move teeth into the proper position over time.
                    </div>
                </div>
                ...
                <div class="qstn_item">
                    ...
                    <div class="qstn_body"> Dental products are used by dentists, dental labs, and sometimes patients,
                        depending on the type and purpose of the product</div>
                </div>
                ...
                <div class="qstn_item">
                    ...
                    <div class="qstn_body">Dental materials are generally classified as preventive, restorative, and
                        auxiliary materials used in various dental procedures.</div>
                </div>
                ...
                <div class="qstn_item">
                    ...
                    <div class="qstn_body">Restorative dental materials are used to repair or replace damaged or missing
                        tooth structure caused by decay, wear, or injury.</div>
                </div>
                    ...
                    <a href="<?= url_to('contact') ?>" class="qstn_btn">
                        ...
                        <span class="btn_icon">
                            ...
                            <svg width="16" height="16" viewBox="0 0 24 24">
                                <path d="M5 12h14M13 5l7 7-7 7" stroke="#1f7db0" stroke-width="2" fill="none" />
                            </svg>
                        </span>
                    </a>
                </div>
    ...
    <section class="customer-review-area gl-mt-35">
        ...
        <div class="review-header">
            <div class="review-left">
                <div class="review-sub g-slide-up">CUSTOMER REVIEWS</div>
                <div class="review-title g-slide-up">Real results from Real people</div>
            </div>
...
<div class="container-common">
    <section class="speak_form_area">
        ...
        <div class="speak_form_inner">
            ...
            <!-- LEFT SIDE -->
            <div class="speak_left g-slide-up">
