...
<div class="other_common_banner pad-top-140">
    ...
    <div class="container-common-product">
        ...
        <div class="ocb_breadcrumb">
            ...
            <a href="#">Products</a>
            <span>/</span>
            <a href="<?= url_to('category-detail', $product['category_slug']) ?>"><?= esc($product['category_name']) ?></a>
            <?php if (! empty($product['subcategory_name'])): ?>
                <span>/</span>
                <a href="<?= url_to('category-detail', $product['category_slug']) ?>"><?= esc($product['subcategory_name']) ?></a>
            <?php endif; ?>
            <span>/</span>
            ...
            <div class="product_wrapper">
                ...
                <div class="product_images">
                    ...
                    <div class="main_image" id="zoomContainer">
                        <img id="mainProductImage" src="<?= base_url(esc($mainImage)) ?>" alt="<?= esc($product['name']) ?>">
                    </div>
                ...
                <div class="product_content">
                                ...
                                <div class="ocb_breadcrumb">
                                    ...
                                    <a href="<?= url_to('category-detail', $product['category_slug']) ?>"><?= esc($product['category_name']) ?></a>
                                    <span>></span>
                                    <a href="<?= url_to('category-detail', $product['category_slug']) ?>" class="active"><span class="content_truncate-right-content"><?= esc($product['subcategory_name']) ?></span></a>
                                </div>
                                ...
                                <h4 class="prd-info">Product information</h4>
...
<div class="special_grids pt-90s">
    ...
    <div class="special_track" id="specialTrack">
        ...
        <div class="special_item">
            <img src="<?= base_url('web/assets/images/product-detail/genuine.svg')?>" alt="">
        ...
        <div class="special_item">
            <img src="<?= base_url('web/assets/images/product-detail/best-practice.svg')?>" alt="">
            <div class="special_text">
                <div>Best</div>
        ...
        <div class="special_item">
            <img src="<?= base_url('web/assets/images/product-detail/speed-dev.svg')?>" alt="">
            <div class="special_text">
                <div>Fast Pan</div>
        ...
        <div class="special_item">
            <img src="<?= base_url('web/assets/images/product-detail/warrenty.svg')?>" alt="">
            <div class="special_text">
        ...
        <div class="special_item">
            <img src="<?= base_url('web/assets/images/product-detail/call-service.svg')?>" alt="">
            <div class="special_text">
                <div>Dedicated</div>
                <div>Support</div>
            </div>
        ...
        <div class="related_products-slider gl-pb-70 brd-btm-new">
            <div class="related_products-track">
                ...
                <div class="rp-slide">
                    ...
                    <div class="rp-inner"><img src="<?= base_url(esc($relatedProduct['thumbnail'] ?: 'web/assets/images/orthodontics/product.webp')) ?>"></div>
                    </a>
                </div>
                <?php endforeach; ?>
            ...
            <div class="review-track">
                ...
                <div class="review-card">
                    ...
                    <div class="review-text">
                        I’ve been using these dental resins for over a year now, particularly for crown and bridge work,
                        and the consistency has been outstanding.
                    </div>
                ...
                <div class="review-card">
                    ...
                    <div class="review-text">
                        As an orthodontist working with clear aligners and splints, I rely heavily on the quality of my
                        printed models. These resins have delivered excellent durability and dimensional stability, even
                ...
                <div class="review-card">
                    ...
                    <div class="review-text">
                        In our lab, we deal with a wide range of applications, from surgical guides to denture bases,
                        and these resins have proven to be extremely versatile.
                    </div>
                ...
                <div class="review-card">
                    ...
                    <div class="review-text">
                        I primarily use surgical guide resins, and the level of precision offered here is excellent. The
                        guides fit perfectly, which is critical for implant procedures where accuracy is non-negotiable.
                    </div>
                ...
                <div class="speak_info gl-pt-50 gl-xs-pt-20">
                    ...
                    <div class="info_box">
                        ...
                        <div>
                            ...
                            <a href="mailto:moriza@dental.com" target="_blank"
                                class="info_text gl-td-none">moriza@dental.com</a>
                        </div>
                    </div>
    ...
    <script>
        ...
        if (specialSliderTrack && window.innerWidth <= 750) {
            ...
            function animateSlider() {
                ...
                if (Math.abs(position) >= specialSliderTrack.scrollWidth / 2) {
                    position = 0;
                }

                specialSliderTrack.style.transform = `translateX(${position}px)`;
